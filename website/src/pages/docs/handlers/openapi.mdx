...
<PackageCmd packages={['@graphql-mesh/openapi']} />
...
import { MeshContext } from '@graphql-mesh/types';
...
See [Subscriptions & Webhooks](../subscriptions-webhooks.md) to create an endpoint to consume a
